 ...
 * various auto-histogram `Aggregation` implementations like
 ...
 * @param {number=} bucket count to generate histogram over.
 *
 * @extends BucketAggregationBase
 */
class AutoHistogramAggregationBase extends BucketAggregationBase {
    // eslint-disable-next-line require-jsdoc
    constructor(name, aggType, field, buckets) {
...
module.exports = AutoHistogramAggregationBase;
