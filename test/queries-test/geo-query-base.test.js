...
const getInstance = (field = 'my_field') => new GeoQueryBase('my_qry_type', field);
...
test(validatedCorrectly, getInstance, 'validationMethod', ['IGNORE_MALFORMED', 'COERCE', 'STRICT']);
