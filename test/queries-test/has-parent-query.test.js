...
import { illegalCall, nameExpectStrategy, makeSetsOptionMacro } from '../_macros';

const setsOption = makeSetsOptionMacro(hasParentQuery, nameExpectStrategy('has_parent'));
...
test('constructor sets argumetns', t => {
    ...
    const valueB = new HasParentQuery().parentType('my_type').query(qry).toJSON();
