...
import { AutoHistogramAggregationBase } from '../../src/aggregations/bucket-aggregations';
import { nameTypeExpectStrategy, makeSetsOptionMacro } from '../_macros';

const getInstance = (...args) =>
    new AutoHistogramAggregationBase('my_agg', 'my_type', ...args);
...
test(setsOption, 'buckets', { param: 10 });
